# Thorn — Sr ML Eng Take-Home Assignment (verbatim)

Received: 2026-08-20. Due back within one week (~2026-08-25/26).

---

The next step is a short homework assignment, which we have included below, and we ask that you return it to us within one week. That being said, if you need additional time, please don't hesitate to reach out.

## Assignment (please submit to link below)
...
"I'm seeing a lot of bad predictions where the image is sort of like a grid or collage and they seem to have lots of lines running through them."

"A bunch of the images in my review queue have watermarks and text in them and almost none of them are actually actionable."

"The model is flagging lots of messy looking images that are hard to make out and sort of low quality. The predictions are basically never right on these."

Your task is to use this feedback to reproduce the reported false-positive behavior. You should have received:

- A set of benign base images that the model correctly classifies as "other".
- The image classifier weights.
- A repository containing the code required to run and evaluate the model.
...
- Two to three images that produce a false-positive dog prediction.
...
We can't wait to receive and review your submission! If you have any questions in the meantime, please feel free to reach out.
